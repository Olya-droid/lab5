...
public class Update {
     ...
     * @param route  объект
     */
    protected static void changeName(Reader reader, Route route) {
     ...
     * @param route  объект
     */
    protected static void changeCoordinates(Reader reader, Route route){
     ...
     * @param route  объект
     */
    protected static void changeFrom(Reader reader, Route route) {
        System.out.print("\n" + "Откуда? (from)" + "\n" + "long x = ");
     ...
     * @param route  объект
     */
    protected static void changeTo(Reader reader, Route route) {
        System.out.print("\n" + "Куда? (to)" + "\n" + "long x = ");
        String s = reader.getLine()+"";
        if (s.equals("") ) {
            System.out.println("Введена пустая строка. Не надо так.");
     ...
     * @param route  объект
     */
    protected static void changeDist(Reader reader, Route route) {
